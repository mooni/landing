...
export default function SEO({ data }) {
      return (
        <Head>
              ...
              <meta itemProp="image" content="https://mooni.tech/images/seo/meta_card.jpg"/>

              <meta property="og:type" content="website"/>
              <meta property="og:url" content="https://mooni.tech/"/>
              <meta property="og:title" content={data.title}/>
              <meta property="og:description" content={data.description}/>
              <meta property="og:image" content="https://mooni.tech/images/seo/meta_card.jpg"/>
              ...
              <meta property="twitter:image" content="https://mooni.tech/images/seo/twitter_card.jpg"/>
